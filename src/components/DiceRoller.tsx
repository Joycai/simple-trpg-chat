  ...
  return (
    <div className="bg-surface border border-border rounded-lg p-4 shadow-lg animate-in fade-in slide-in-from-bottom-2">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <button
          onClick={handleRoll}
          className="flex-1 bg-accent hover:bg-accent-hover text-accent-foreground font-bold py-2 px-4 rounded-lg transition flex items-center justify-center gap-2 shadow-lg"
        >
          <span>🎲</span>
          <span>
            {count}d{selectedDie}
