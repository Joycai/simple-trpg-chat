...
| `messages` | id, roomId, userId, targetUserId, nickname, content, type, diceDetail, audience, isPrivate, createdAt | `audience` (everyone/self/directed/dm/gm) owns visibility — see `docs/arch/realtime.md`. `isPrivate` is a legacy derived mirror |
