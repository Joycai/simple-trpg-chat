...
db.config.json                # Database connection config (auto-generated by setup.sh)
```
...
- **Database configuration**: `db.config.json` at project root (auto-generated by `setup.sh`). Only PostgreSQL is supported. The file contains `{ "type": "postgresql", "url": "postgres://..." }`.
